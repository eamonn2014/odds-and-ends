...
output$text.reg.notes <- renderText({  # create text
    ...
    print(paste0(   
        ...
        tags$span(style="color:blue;font-weight:bold;font-size: 15px;", 
...
# textInput('repz', 
#           strong(div(h5(tags$span(style="color:blue", 
#            "Replicates and rep minimum")))), "2,1")

textInput('sigma.miz', 
          strong(div(h5(tags$span(style="color:blue", 
            "Method-specific standard deviations for a method by sample random effect. Some or all components can be zero.")))), "0.062,0.062")

textInput('sigma.irz', 
          strong(div(h5(tags$span(style="color:blue", 
            "Method-specific standard deviations for the sample by replicate random effect.")))), ".02,.03")

textInput('sigma.mirz', 
          strong(div(h5(tags$span(style="color:blue", 
            "A vector of method-specific residual standard deviations for a method by sample by replicate random effect (residual variation). All components must be greater than zero.")))), "0.128,0.143")
...
textInput('mizz', 
 ...
 #  selectInput("SD.typez", "Select \u03C3 type",          choices = c("cons", "lin"), selected="cons")
  
#  selectInput("Dif.typez", "Select difference type", choices = c("cons", "lin"), selected="cons")
  
  
  
  
    selectInput("Pl.typez", "Select plot",             choices = c("BA", "conv"), selected="BA")
 selectInput("modelz", "Model: reps exch or linked?",             choices = c("exch", "linked"), selected="exch")
