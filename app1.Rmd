...
```{r}
    ...
    "Select true group standard deviations: randomly select using range or uniquely select", 
      ...
      textInput("pr1", div(h5(tags$span(style="color:blue", "Prop Chg"))), value= "0.90")
      textInput("pr2", div(h5(tags$span(style="color:blue", "Prop Chg"))), value= "0.90")
      textInput("pr3", div(h5(tags$span(style="color:blue", "Prop Chg"))), value= "1.00")
...
random.sample2 <- reactive({
    ...
    zx1    <- as.numeric(    eval(parse(text= (input$zx1)) ) )
    zx2    <- as.numeric(    eval(parse(text= (input$zx2)) ) )
    zx3    <- as.numeric(    eval(parse(text= (input$zx3)) ) )
