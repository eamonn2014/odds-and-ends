...
output$text101 <- renderText({  # create interactive text t1
    ...
    ,   tags$span(style="color:black;font-weight:bold;font-size: 20px;", " with intercept added ") 
...
inference <- reactive({
  ...
  return(list(
         ...
         Xa=xa, Xb=xb, weights=weights, X1=X1, X2=X2, betas=betas, var.cov=var.cov, est=est, se=se, lower=lower,
