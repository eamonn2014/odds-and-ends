...
# reactive({
#   
# cat(paste0("A method comparison with ",input$n," samples assayed on each method."))
# 
# cat(paste0(" There is a true bias of ", input$eff.p, " We also have a true correlation ",input$r," and between sample sd commmon to both methods of ", input$sd.,".\nThere are no technical replicates. "))
# 
# cat(paste0("Based on the true parameters the variance of the difference is ", r1()$true," and the estimate from a simulated experiment is ", r1()$est) )
# 
#  
# })
...
output$text2a <- renderText({  # create interactive text t1
    ...
    tags$span(style="color:black;font-weight:bold;font-size: 20px;", 
               ...
               "The following is the covariance between the two variables. We add 2 x this if we are interested in the variance of the sum, for the variance of the difference we subtract this component. ")))
...
output$text3 <- renderText({  # create interactive text t1
    ...
    ", We also have a true correlation between the paired results of ")
    ...
    " There are no technical replicates. "),
        ...
        tags$span(style="color:black;font-weight:bold;font-size: 20px;", 
         ...
         , tags$span(style="color:blue ;font-weight:bold;font-size: 20px;", r1()$true) ,
    
     tags$span(style="color:black;font-weight:bold;font-size: 20px;", 
               
               " and the estimate from a simulated experiment is ") 
    
     , tags$span(style="color:blue ;font-weight:bold;font-size: 20px;",  r1()$est) ,
