...
lmm <-  reactive({
  ...
  renderPrint({
    ...
    cat("\nTo calcualte the sd.pred for 2 methods sum each method's component's (MxI^2, res^2) and take the square root. The item×replicate (IxR)
standard deviation is not related to the method comparison, but only to the study design.\n")
    print(m1)
