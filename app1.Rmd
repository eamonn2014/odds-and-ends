...
```{r tab1}
  ...
  sliderInput('sd.', 'Common constant SD', 1,
...
output$text3 <- renderText({  # create interactive text t1
    ...
    ". By design the SD is constant across the range of values. Think of this SD component as the between person SD. Increase it to see the range of scores increase. There are no technical replicates ", #),
...
output$text4a <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "Notice there are no replicates per sample on each method. Therefore the repeatability of each method cannot be estimated, this is a deficiency in the experimental design.")) )
