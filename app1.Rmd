...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  textInput('sigma.irz', 
            strong(div(h5(tags$span(style="color:blue", 
              "'IxR' Method-specific standard deviations for the sample by replicate random effect. Only one can be estimated, if >0 this means reps are linked! The minimum reps (above box) only come into play if this is zero!")))), "0.05")
# 0.02,0.03, 0.05
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
The top two drop down menus allow different modelling approaches.  
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
  output$textmcr1 <- renderText({  # create interactive text t1
    ...
    tags$span(style="color:black;font-weight:bold;font-size: 20px;", 
               ...
               "Set variance components of MXI to zeros to allow exchangable replicate design.\n"),
