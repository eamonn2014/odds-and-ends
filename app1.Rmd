...
output$text5 <- renderText({  # create interactive text t1
    ...
    tags$span(style="color:black;font-weight:bold;font-size: 20px;", 
     ...
     , tags$span(style="color:blue;font-weight:bold;font-size: 20px;", inference()$res) ,
...
```{r}
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   splitLayout(
    textInput("qq", div(h5(tags$span(style="color:blue", "contrast"))), value= "A, B"),
