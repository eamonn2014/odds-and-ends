...
---
Method Comp. no reps {data-icon="fa-pencil"}
===
...
Anova (linear model) contrasts {data-icon="fa-cog"}
====
...
output$text.wiki2a <- renderText({  # create interactive text t1
    ...
    "The next tab 'Method Comp. (no replication)' is set up is a typical method comparison experiment, that is no replication, an inferior design. On the same main tab are mini tabs exploring assumptions", #),
...
output$text.wiki3 <- renderText({  # create interactive text t1
    ...
    "We change tack on the T test example tab. This is not directly related to method comparison but another programming exercise.
...
output$text.wiki4 <- renderText({  # create interactive text t1
    ...
    " The Anova tab, again not directly related to method comparison, allows the user to define 4 lognormal distributed variables of user defined sample sizes, sds and proportional differences.  The idea behind this tab is to perform and understand contrasts. On the left is Frank Harrell's contrast function and on the right we step through how a contrast is calculated
    ", #),
...
#                
#     "  
#       ideas to include/mention :
#       <br>
#       <span>Vicker's code ;         </span><br>
#       <span>Pitman's test ;         </span>
#       <span>diagnostis for ANOVA ;  </span>
#       <span> pi/2 explanation ;     </span>
#       <span>Gelmans book residuals ;</span>
#       <span>drop some reps ;        </span>
#       <span>anova diagnostics ;     </span>
#       <span>ttest diagnostics ;     </span>
#     ", #),
#     
#     
#         ".") ))
