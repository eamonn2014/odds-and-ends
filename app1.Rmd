...
```{r tab1}
  ...
  sliderInput('eff.p', 'Constant bias', value = c(0),
...
output$text4 <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     , tags$span(style="color:blue ;font-weight:bold;font-size: 20px;", formatz3( sqrt(r1()$est)),
        ...
        ", this matches the methComp estimate with the default settings, see the estimate in brackets in the Bland Altman plot below right"),".") ))
...
# 0.9  0.09
 ...
 output$text55 <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     , tags$span(style="color:blue;font-weight:bold;font-size: 20px;",  random.sample2()$conf )
     
     , tags$span(style="color:black;font-weight:bold;font-size: 20px;", " % interval of the contrast must lie within ") 
                   
     , tags$span(style="color:blue;font-weight:bold;font-size: 20px;",  (random.sample2()$qc *100)/100 )
    
     , tags$span(style="color:black;font-weight:bold;font-size: 20px;", " and ") 
    
     , tags$span(style="color:blue;font-weight:bold;font-size: 20px;",  formatz3(100/(random.sample2()$qc *100) )) 
   
   #  , tags$span(style="color:black;font-weight:bold;font-size: 20px;", " with 95%CI ( ") 
...
renderPlot({
  ...
  delta <-   random.sample2()$delta
    ...
    MASS::truehist(A, 
                  yaxt='n' ,
                  nbins=br,  axes=FALSE,
    main=paste0("A. N=",N," realisations from log-normal mu=",p3(logN.mu),", SD=", p3(logN.SD),
                ", Geometric Mean=",p3(A.GM)), col = "blue", 
    ...
    MASS::truehist(B, 
                    yaxt='n' ,
                    nbins=br,  axes=FALSE,
    main=paste0("B. N=",N," realisations true log-normal mu=",mux*zx,", SD=",p3(logN.SD),
                ", Geometric Mean=",p3(B.GM) ,"\nTreatment effect ",mux*zx," / ",mux,"=",zx), 
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    tags$span(style="color:black;font-weight:bold;font-size: 20px;", 
               ...
               "Lower and upper limits (est +/- zcrit * se)") 
...
### Logged data with anti-log y axis labels
