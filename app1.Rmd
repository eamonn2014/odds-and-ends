...
```{r tab1q}
  ...
  # range <- c(0,10)
       ...
       sliderInput("res", 
               ...
               min = 2, max = 50, value = c(10, 10), ticks=FALSE) 
       ...
       sliderInput("alphas", 
               "Select alpha", 
               min = -10, max = 10, value = c(0, 0), ticks=FALSE) 
   
       sliderInput("betas", 
               "Select betas", 
               min = -10, max = 10, value = c(1, 1), ticks=FALSE) 
      
       sliderInput("ranges", 
               "Select range", 
               min = 0, max = 100, value = c(0, 100), ticks=FALSE) 
  ...
  sliderInput('mu0q', 'Initial mean  \u03BC', value=0,
                min = -100, max = 100, step=5, ticks=F)
  
  sliderInput('eff.pq', 'Constant difference', value = c(0),
                min = -25, max = 25 ,step=1, ticks=F)
  
  sliderInput('sd.q', 'Common constant \u03C3', 1,
                min = 1, max = 100, step=1,ticks=F)

  sliderInput('rq', 'Correlation \u03C1', value = c(.8),
                min = -.9, max = .9, step=0.05, ticks=F)
  ...
  selectInput("Dif.typeq", "Select difference type", choices = c("cons", "lin"), selected="cons")
