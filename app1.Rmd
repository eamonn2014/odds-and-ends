...
output$e100 <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "MI is the method×item component, you can see it affects the same method items which receive a shift, a realisation from a method specific sd, namely ~N(0,sigma.mi). As explained by Bendix Carsrensen 'The introduction of a third method allows the separation of the
