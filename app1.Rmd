...
output$e99b <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "IR is the item x replicate component, this is a shift from the sigma.ir normal distribution based on realisations from sigma.ir. This is only for a linked experiment, for example the same items replicates receive the same shift regardless of method. So this component has nothing to do with the methods.")) )
