...
MASS::truehist(log(A), yaxt='n' , nbins=br,  axes=FALSE,
               main=paste0("A. N=",N," realisations true Normal mu=",p3(mu),", SD=", p3(sd),""), col = "blue", border = "white",  xlab="log scale")
...
MASS::truehist(B, 
                yaxt='n' ,
                nbins=br,  axes=FALSE,
               main=paste0("B. N=",N," realisations true log-normal mu=",mux*zx,", SD=", p3(logN.SD),", Geometric Mean=",p3(B.GM) ," Treatment effect ",mux*zx," / ",mux,"=",zx), 
...
MASS::truehist(log(B), yaxt='n' , nbins=br, axes=FALSE, 
               main=paste0("B. N=",N," realisations true Normal mu=",p3(mu+delta),", SD=",p3(sd)," Treatment effect ", p3(mu+delta)," - ",p3(mu),"=",
