...
```{r, test}
  ...
  HTML("  If the variables are uncorrelated the variance of the difference is equal to the sum of the variances. If there is any correlation this information is incorporated: ")
                                       
  withMathJax(
                                           helpText('
                             $${{ }{{{\\sigma^2}{_{x \\pm y}} =  {\\sigma^2}{_{x}}  +  {\\sigma^2}{_{y}}                \\pm 2\\rho{\\sigma}{_{x}}   {\\sigma}{_{y}}           }}}\\!$$'))      
  
  HTML(" The following is the covariance between the two variables. We add 2 x this if we are interested in the variance of the sum, for the variance of the difference we subtract this component.")
...
```{r } 
   ...
   output$text3 <- renderText({  # create interactive text t1
    ...
    " or ")
     ...
     , tags$span(style="color:red ;font-weight:bold;font-size: 20px;", input$sd.) ,
