...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  textInput('sigma.irz', 
            strong(div(h5(tags$span(style="color:blue", 
              "'IxR' Method-specific \u03C3s for the sample by replicate random effect. Only one can be estimated, if >0 this means reps are linked! The minimum reps (above box) only come into play if this is zero!")))), "0.05")
# 0.02,0.03, 0.05
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 
  textInput('sigma.miz', 
            strong(div(h5(tags$span(style="color:blue", 
              "'MxI' Method-specific \u03C3s for a method by sample random effect. Some or all components can be zero.")))), "0.062,0.062, 0.05")

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

  textInput('sigma.mirz', 
            strong(div(h5(tags$span(style="color:blue", 
              "'res' A vector of method-specific residual \u03C3s for a method by sample by replicate random effect (residual variation). All components must be greater than zero.")))), "0.128,0.143, 0.222")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  textInput('sigma.irzB', 
            strong(div(h5(tags$span(style="color:blue", 
              "sigma.ir produces 'IxR' Method-specific shift \u03C3s for the sample by replicate random effect. Only one can be estimated, if >0 this means reps are linked! The minimum reps (above box) only come into play if this is zero!")))), "0.05")
# 0.02,0.03, 0.05
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 
  textInput('sigma.mizB', 
            strong(div(h5(tags$span(style="color:blue", 
              "sigma.ir produces 'MxI' Method-specific shift\u03C3s for a method by sample random effect. Some or all components can be zero.")))), "0.062,0.04, 0.05")
...
Column {.tabset .tabset-fade .width=600}  
-----------------------------------------------------------------------
...
output$e99 <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "The listing includes the design matrix, the true population parameters and the eventual response y.")) )
...
output$e99b <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "IR is the item x replicate component, this is a shift based on realisations from sigma.ir. This is only for a linked experiment, for example the same items replicates receive the same shift regardless of method. So this component has nothing to do with the methods.")) )
...
output$e100 <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "MI is the method x item component, you can see it affects the same method items which receive a shift realisation from a method specific sd, namely sigma.mi")) )
...
output$e101 <- renderText({  # create interactive text t1
    ...
    print(paste0(   
     ...
     "MIR is the method x item x rep component, repeatability or residual you can see it affects each replicate which receive a realisation from a method specific sigma.mir.")) )
