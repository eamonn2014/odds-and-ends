...
output$text.reg.notes2 <- renderText({  # create text
    ...
    print(paste0(   
     ...
     "In the methods box the first entry is the no. of methods. The following are those that are presented in the BA plot top left.")) )
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  textInput('sigma.miz', 
            strong(div(h5(tags$span(style="color:blue", 
              "Method-specific standard deviations for a method by sample random effect. Some or all components can be zero.")))), "0.062,0.062, 0.05")

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

  textInput('sigma.irz', 
            strong(div(h5(tags$span(style="color:blue", 
              "Method-specific standard deviations for the sample by replicate random effect.")))), "0.02,0.03, 0.05")

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

  textInput('sigma.mirz', 
            strong(div(h5(tags$span(style="color:blue", 
              "A vector of method-specific residual standard deviations for a method by sample by replicate random effect (residual variation). All components must be greater than zero.")))), "0.128,0.143, 0.222")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  selectInput("modelz", "Model: replicates exchangable or linked?",  
...
# not used yet
  ...
  lmm <-  reactive({
    ...
    fL <- BA.est( foo, linked=TRUE )

   return(list(f=f, fL=fL))
