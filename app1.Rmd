...
---
Method Comp. no reps {data-icon="fa-home"}
===
...
Method Comp. reps! {data-icon="fa-cog"}
===
...
Method Comp. listing  {data-icon="fa-cog"}
===
...
Anova (linear model) contrasts {data-icon="fa-pencil"}
====
...
```{r top , height=50, eval=FALSE}
 ...
 #h5(htmlOutput("text5"))
# h5(htmlOutput("text107a")) # this works here!
...
# -------------------------------------
#   
# ### Walking through the calculation steps for a contrast { data-height=1200}
#   
...
output$text.wiki2a <- renderText({  # create interactive text t1
    ...
    "The first tab 'Method Comp. no reps' is a typical method comparison experiment, that is no replication, an inferior design. On the same main tab are mini tabs exploring assumptions", #),
