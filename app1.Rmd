...
```{r not metcomp}
  ...
  #    })
    ...
    tags$span(style="color:blue;font-weight:bold;font-size: 20px;", 
      ...
      "\nSelect 2 methods to try this approach. Here's our reference LME model that specifies a symmetric matrix structure for both between-subject and within-subject variances.\nNo Equality Constraints.\n"))
