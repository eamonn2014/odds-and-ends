...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  b <- barplot(yb, xlim=c(0,xmax+2), ylab = "Percent", xlab="Count of failed attempts (X-r)", col='red',
          ylim=c(0,ymax),
 ...
 # ymin = input$y_range[1]
  ...
  b <- barplot(d , #x/sim, 
               ...
               main = paste0("Number of attempts until we reach ",s," successes when p=",formatz2(P),
                                    "\n True \u03BC ",formatz2(input$mu) , #" ; Simulated \u03BC (green) ",formatz2(Sm) ,
                             ""),
               col="palegreen", 
               ylab="Probability of success", 
               xlab="Attempts for success (no simulation)",
...
```{r, tab1 plot3, eval=TRUE}
 ...
 # x <- table(factor(number_of_attempts, levels = s: ymax)) # pad out so levels so no counts included
  ...
  b <- barplot(x/sim, 
               ...
               col="palegreen", 
               ylab="Probability of success", 
               xlab="Attempts for success (true negative binomial distribution red line with true %s above bars)")
