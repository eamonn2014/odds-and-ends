...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# recruitment function using neg binomial simulation
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
```{r tab1}
  ...
  sliderInput('alpha_a', '\u03B1 for red curve', value = c(1.3),
    ...
    sliderInput('P', 'Probability of Success', value=.5,
                min = 0, max = 1, step=.1, ticks=F)
  
  sliderInput('s', 'No of successess', value = c(3),
  ...
  sliderInput('sims', 'Simulations (chart 2)', 15000,
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 # par(mar=c(2.1,4.1,4.1,4.1))
  ...
  b <- barplot(yb, xlim=c(0,xmax+2), ylab = "Percent", xlab="count", col='red',
          ylim=c(0,ymax),
...
```{r, tab1 plot3, eval=TRUE}
 ...
 # x <- table(factor(number_of_attempts, levels = s: ymax)) # pad out so levels so no counts included
  ...
  b <- barplot(x/sim, 
               ...
               xlab="Attempt (true negative binomial dist. red line)")
