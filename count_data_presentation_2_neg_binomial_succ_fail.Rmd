...
# 
   output$text2 <- renderText({  # create interactive text t1
    ...
    tags$span(style="color:blue;font-weight:bold;font-size: 20px;", 
            ...
            #   "Here we count the number of the trial at which the rth success occurs "
            )   ,
      br(),
      br(),
    ...
    # " or ")
    # 
    #  , tags$span(style="color:red ;font-weight:bold;font-size: 20px;", r) ,
    # 
  ...
  renderPrint({
    ...
    fail <- choose(r+x-1,x)*p^r*(1-p)^(x)
     ...
     d <- dnbinom(x, r, prob=p)
     
      cat("Trial...\n")
      print(x)
      cat("Probability of rth success at trail x using upper equation (before the rth trial prob is zero (can be negative as John Cook mentions, see ref))\n")
      print(succ)
      cat("Probability of x failed trials before rth success (lower equation)\n")
      print(fail)
      cat("Probability using dnbinom function\n")
      print(d)
