...
```{r qc3}
  ...
  HTML("Taken from John D Cooke, see references, consider µ and σ primary and r and p derived:")
 ...
 withMathJax(
  ...
  br()
   ...
   HTML("Viewing µ and σ as primary, we ignore the combinatorial motivation for
