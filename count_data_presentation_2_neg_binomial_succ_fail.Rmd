...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   # write an equivalent to e_dnbinom see here for Probability Mass Function on page 1
   # this is not used but just  a qc check, this si useful doc
...
```{r input4}
  ...
  sliderInput('betax', 'Beta', value = c(2/3), #3
...
renderPlot({
  ...
  b <- barplot(d, 
               xlim=c(0,xmax+2),  
               ylim=c(0,ymax),
               main = paste0("Empirical distribution (via simulation) of the Poisson-Gamma mixture\nThe Poisson mean is rgamma(shape= ", r,", rate= ", beta,")\n"),
               col="orchid1", 
               ylab="Probability", 
               xlab=paste("Counts"),
               names.arg= as.character(xx))
...
### Use the mu and alpha left and plot this for completeness
